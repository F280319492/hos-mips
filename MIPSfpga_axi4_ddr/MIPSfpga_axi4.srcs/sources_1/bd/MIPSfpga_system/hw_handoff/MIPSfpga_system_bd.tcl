...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set BT_UART_TXD_IN [ create_bd_port -dir I BT_UART_TXD_IN ]
  set BT_UART_TXD_OUT [ create_bd_port -dir O BT_UART_TXD_OUT ]
...
CONFIG.USE_LOCKED {false} CONFIG.USE_RESET {false} \
  ...
  connect_bd_net -net BT_UART_TXD_IN_1 [get_bd_ports BT_UART_TXD_IN] [get_bd_pins axi_uart16550_1/sin]
  ...
  connect_bd_net -net MIPS_MicroAptiv_UP_0_HCLK [get_bd_pins MIPS_MicroAptiv_UP_0/HCLK] [get_bd_pins PWM_w_Int_0/s00_axi_aclk] [get_bd_pins ahblite_axi_bridge_0/s_ahb_hclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/M06_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_uart16550_0/s_axi_aclk] [get_bd_pins axi_uart16550_1/s_axi_aclk]
  ...
  connect_bd_net -net axi_uart16550_1_sout [get_bd_ports BT_UART_TXD_OUT] [get_bd_pins axi_uart16550_1/sout]
  ...
  connect_bd_net -net xlconstant_4_dout [get_bd_pins xlconcat_1/In0] [get_bd_pins xlconcat_1/In1] [get_bd_pins xlconcat_1/In2] [get_bd_pins xlconcat_1/In3] [get_bd_pins xlconcat_1/In7] [get_bd_pins xlconstant_4/dout]
