...
set_property -dict { PACKAGE_PIN J2    IOSTANDARD LVCMOS33 } [get_ports { BT_UART_TXD_OUT }]; #IO_L22N_T3_35 Sch=jc[3]    #rx
set_property -dict { PACKAGE_PIN G6    IOSTANDARD LVCMOS33 } [get_ports { BT_UART_TXD_IN }]; #IO_L19P_T3_35 Sch=jc[4]   #tx
